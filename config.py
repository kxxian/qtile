...
keys = [
    ...
    Key([mod], "w", lazy.spawn("brave"), desc="Launch Web Browser"),
    Key([mod, "shift"], "f", lazy.spawn("pcmanfm"), desc="Launch File Manager"),
    Key([mod], "v", lazy.spawn("pavucontrol"), desc="Launch Volume Control"),
    Key([mod], "b", lazy.spawn("blueman-manager"), desc="Launch Bluetooth"),
    Key([mod], "s", lazy.spawn("flameshot full"), desc="Screenshot"),
...
colors = [
    ["#012B36", "#012B36"],  # bg        (primary.background)
    ["#063642", "#063642"],  # fg        (primary.foreground)
    ["#00141A", "#00141A"],  # color01   (normal.black)
    ["#DC322F", "#DC322F"],  # color02   (normal.red)
    ["#859901", "#859901"],  # color03   (normal.green)
    ["#B48900", "#B48900"],  # color04   (normal.yellow)
    ["#278BD2", "#278BD2"],  # color05   (normal.blue)
    ["#D33682", "#D33682"],  # color06   (normal.magenta)
    ["#2AA198", "#2AA198"],  # color15   (bright.cyan)
...
sep = widget.Sep(linewidth=1, padding=8, foreground=colors[1])
